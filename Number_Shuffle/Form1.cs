    ...
    public partial class Form1 : Form
    {
        ...
        public void SolutionChecker()
        {
            if(button1.Text == "1" && button2.Text == "2"
                ...
                && button9.Text == "9" && button9.Text == "9"
                && button10.Text == "10" && button11.Text == "11" &&
                button12.Text == "12" && button13.Text == "13"
                && button14.Text == "14" && button15.Text == "15" 
                && button16.Text == "")
            {
                MessageBox.Show("Well done you are a winner!", "Shuffle Game", MessageBoxButtons.OK,
                    MessageBoxIcon.Information);
            }

            Counter = Counter + 1;
            textBox1.Text = "Number of clicks: " + Counter;
            textBox2.Text = Convert.ToString(500 - Counter);
            if(Counter == 500)
            {
                DialogResult OutOfTries = MessageBox.Show("You clicked 500 times, You lost!", "Shuffle Games",
